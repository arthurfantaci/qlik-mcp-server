...
class GetAppScriptArgs(BaseModel):
    ...
    analyze_script: Annotated[bool, Field(
        default=False,
        description="Enable comprehensive script analysis including BINARY LOAD detection, statement counts, and variable extraction."
    )] = False
    ...
    max_preview_length: Annotated[Optional[int], Field(
        default=None,
    ...
    @classmethod
    def validate_preview_length(cls, v: Optional[int]) -> Optional[int]:
